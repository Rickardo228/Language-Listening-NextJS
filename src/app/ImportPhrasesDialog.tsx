...
export interface ImportPhrasesDialogProps {
    ...
    onProcess?: (prompt?: string, inputLang?: string, targetLang?: string, collectionType?: CollectionType, phrasesOverride?: string, name?: string) => Promise<void>
...
export function ImportPhrasesDialog({
    ...
    const handleSubmit = async () => {
        if (onAddToCollection) {
            ...
            await onProcess(undefined, inputLang, targetLang, collectionType, phrasesInput, prompt.trim() || undefined);
            onClose();
        }
    };
