...
export const PRODUCTION_PHRASE_RANKS: Array<{ threshold: number } & RankInfo> =
  [
    ...
    },
    {
      ...
      color: "text-blue-700",
      nextMilestone: 50000,
      description: "You're reaching advanced levels of dedication",
    },
    {
      threshold: 35000,
    ...
    },
    {
      ...
      color: "text-blue-600",
      nextMilestone: 35000,
      description: "You're showing strong commitment to practice",
    },
    {
      threshold: 25000,
    ...
    },
    {
      ...
      nextMilestone: 25000,
      description: "You're building professional-level practice habits",
    },
    {
      threshold: 15000,
    ...
    },
    {
      ...
      color: "text-green-600",
      nextMilestone: 15000,
      description: "You're maintaining excellent practice consistency",
    },
    {
      threshold: 10000,
    ...
    },
    {
      ...
      nextMilestone: 10000,
      description: "You're showing reliable practice habits",
    },
    {
      threshold: 5000,
      title: "Regular User",
    ...
    },
    {
      ...
      color: "text-yellow-600",
      nextMilestone: 5000,
      description: "You're staying engaged with regular practice",
    },
    {
      threshold: 2500,
    ...
    },
    {
      ...
      nextMilestone: 2500,
      description: "You're developing a solid practice routine",
    },
    {
      threshold: 1000,
    ...
    },
    {
      ...
      nextMilestone: 1000,
      description: "You're getting comfortable with the app",
    },
    {
      threshold: 500,
      title: "New User",
    ...
    },
    {
      ...
      color: "text-gray-600",
      nextMilestone: 500,
      description: "You're taking your first steps in practice",
    },
    {
      threshold: 100,
      title: "Just Starting",
    ...
    },
    {
      ...
      color: "text-gray-500",
      nextMilestone: 100,
      description: "Every phrase is a step forward",
    },
    {
      threshold: 25,
      title: "Very New",
      color: "text-gray-400",
      nextMilestone: 50,
      description: "You're very new to this journey",
    },
    {
      threshold: 10,
      title: "First Timer",
...
const DEBUG_PHRASE_RANKS: Array<RankInfo> = [
  ...
  },
  {
    title: "First Step",
    color: "text-gray-600",
    description: "You're taking your first steps",
    nextMilestone: 3,
  },
  {
    title: "Early Learner",
  ...
  },
  {
    title: "Getting Into It",
    color: "text-orange-600",
    description: "You're developing interest",
    nextMilestone: 5,
  },
  {
    title: "Active Learner",
    color: "text-yellow-500",
    description: "You're actively engaging",
    nextMilestone: 6,
  },
  {
    title: "Regular User",
  ...
  },
  {
    title: "Practice Master",
    color: "text-purple-600",
    description: "Mastered consistent practice",
    nextMilestone: 12,
  },
  {
    title: "Ultra Dedicated",
