...
import { defaultPresentationConfig } from '@/app/defaultConfig';
import { defaultAdvantages, SignInPage } from '@/app/SignInPage';
import { getFirestore, doc, getDoc, collection as firestoreCollection, addDoc, query, where, getDocs } from 'firebase/firestore';
import { PhrasePlaybackView } from '@/app/components/PhrasePlaybackView';
import { LanguageFlags } from '@/app/components/LanguageFlags';
